...
const Recruiter = () => {
  const {
    ...
    queryFn: async () => {
      const response = await axios.get(
        `https://mern-job-portal-server-kappa.vercel.app/api/v1/application/recruiter-jobs`,
        {
  ...
  const handleAcceptStatus = (id, recruiterId) => {
    ...
    updateJobStatusMutation.mutate({
      body: newStatus,
      url: `https://mern-job-portal-server-kappa.vercel.app/api/v1/application/${id}`,
    });
  };
